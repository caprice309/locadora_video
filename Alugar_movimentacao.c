...
void alugar_movimentacao() {
    ...
    while (1) {
        ...
        // --- filme já alugado ---
        if (filmes[indiceFilme].alugado == 1) {
            gotoxy(2, 23); printf("FILME JA ESTA ALUGADO!");
            getch();
        ...
        fprintf(arqUpdate, "%s,%s,%s,%s,%s,%s,%s,1\n",
        ...
        // se respondeu "S", continua automaticamente o loop
    } // fim do while(1)
}
